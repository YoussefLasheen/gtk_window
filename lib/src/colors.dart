...
class GTKColors {
  static const Color lightUnfocusedBackground = Color(0xFFFAFAFA);
  static const Color darkUnfocusedBackground = Color(0xFF242424);
  static const Color lightFocusedBackground = Color(0xFFEBEBEB);
  static const Color darkFocusedBackground = Color(0xFF303030);
